...
/* ========================================================================== */
    ...
    public static function getConfig() {
        ...
        $cfg_pending = $inCore->loadComponentConfig("pending");
...
/* ========================================================================== */
    ...
    public function getArticlesList($only_published=true) {
        ...
        $sql = "SELECT con.*,
                       DATE_FORMAT(con.pubdate, '%d.%m.%Y') as tpubdate, DATE_FORMAT(con.pubdate, '%H:%i') as tpubtime, 
                       cat.title as cat_title, cat.seolink as catseolink,
                       cat.showdesc,
                       u.nickname as author,
                       u.login as user_login
                FROM cms_pending con
...
/* ========================================================================== */
    ...
    public function getArticle($id) {
        ...
        $sql = "SELECT  con.*, DATE_FORMAT(con.pubdate, '%d.%m.%Y') as tpubdate, DATE_FORMAT(con.pubdate, '%H:%i') as tpubtime, 
...
/* ========================================================================== */
    ...
    public function deleteArticle($id){
        ...
        $this->inDB->delete('cms_pending', "id='$id'", 1);
        @unlink(PATH.'/images/photos/small/pending'.$id.'.jpg');
        @unlink(PATH.'/images/photos/medium/pending'.$id.'.jpg');
...
/* ========================================================================== */
    ...
    public function addArticle($article){
        ...
        $article['id'] = $this->inDB->insert('cms_pending', $article);
...
/* ========================================================================== */
    ...
    public function updateArticle($id, $article, $not_upd_seo = false){
        ...
        $this->inDB->update('cms_pending', $article, $id);
        return true;
...
/* ========================================================================== */
    ...
    public function cronPendingContent(){
        ...
        $sql =  "SELECT * FROM cms_pending WHERE published = 1 AND pubdate <= '".$date_content."'";
		...
		if ($article['createmenu']){
                ...
                if ($article_id) {
                    ...
                    $image_old = PATH . '/images/photos/small/pending' . $pending_id . '.jpg';
                    ...
                    $image_old = PATH . '/images/photos/medium/pending' . $pending_id . '.jpg';
                    if (file_exists($image_old) && !file_exists($image_new)) { rename($image_old, $image_new); }

                    $inDB->delete('cms_pending', "id=".$pending_id, 1);
                }
            }
        }
